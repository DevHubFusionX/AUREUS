...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col lg:flex-row">
      {/* Left Column - Visual */}
      <div className="lg:flex-1 bg-gradient-to-br from-[#D4AF37] to-[#B8941F] flex items-center justify-center p-4 sm:p-6 lg:p-8 min-h-[200px] lg:min-h-screen">
        <motion.div
        ...
        >
          ...
          <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold mb-2 sm:mb-3 lg:mb-4">Welcome Back</h2>
          ...
          <div className="grid grid-cols-2 gap-2 sm:gap-3 lg:gap-4 text-xs sm:text-sm">
            <div className="bg-white/10 p-2 sm:p-3 lg:p-4 rounded-lg">
              <div className="font-bold text-lg sm:text-xl lg:text-2xl">847.3</div>
              <div>TH/s Network</div>
            </div>
            <div className="bg-white/10 p-2 sm:p-3 lg:p-4 rounded-lg">
              <div className="font-bold text-lg sm:text-xl lg:text-2xl">99.9%</div>
              <div>Uptime</div>
            </div>
          </div>
        </motion.div>
      ...
      <div className="lg:flex-1 flex items-center justify-center p-4 sm:p-6 lg:p-8">
        <div className="max-w-md w-full">
          ...
          >
            ...
            <p className="text-sm sm:text-base text-gray-600">Choose your wallet to sign in</p>
          </motion.div>
          ...
          {/* Security Notice */}
          <motion.div
            className="mt-6 sm:mt-8 p-3 sm:p-4 bg-gray-50 rounded-lg"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            <div className="flex items-center space-x-2 sm:space-x-3 mb-2">
              ...
              <span className="text-sm sm:text-base font-medium text-gray-900">Secure Connection</span>
            </div>
